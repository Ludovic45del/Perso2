...
class GasLowPressureAndHighPressureWorkflowEntity(models.Model):

    class Meta:
        app_label = "cible"
        db_table = "GAS_LOW_PRESSURE_AND_HIGH_PRESSURE_WORKFLOW"
        verbose_name_plural = "gas_low_pressure_and_high_pressure_workflows"
