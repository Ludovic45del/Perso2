...
class SpecialStructuringEntity(models.Model):

    class Meta:
        app_label = "cible"
        db_table = "STOCKS_SPECIAL_STRUCTURING"
        verbose_name_plural = "Stocks_Special_Structuring"
    ...
    materials_mat = models.CharField(max_length=100, blank=True, null=True)
