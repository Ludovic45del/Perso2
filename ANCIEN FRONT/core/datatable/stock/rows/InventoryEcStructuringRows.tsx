...
export default function InventoryEcStructuringRows({object, onClick}: RowProps<InventoryEcStructuringModel>) {
    ...
    >
        ...
        <TableCell>
            <AddAdditionalCommentOption key='AddComment' uuid={object.uuid} type='ec-structuring' comment={object.additionalComment}/>
        </TableCell>
