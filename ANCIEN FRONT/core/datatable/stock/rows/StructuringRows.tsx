...
export default function StructuringRows({object, onClick}: RowProps<StructuringModel>) {
    ...
    >
        ...
        <TableCell>
            <AddAdditionalCommentOption key='AddComment' uuid={object.uuid} type='structuring' comment={object.additionalComment}/>
        </TableCell>
