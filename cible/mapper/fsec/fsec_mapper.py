...
def fsec_mapper_entity_to_bean(entity: FsecEntity) -> FsecBean:
    ...
    return FsecBean(
        ...
        is_current_version=entity.is_current_version,
        ...
        embase=entity.embase,
        restitution_date=entity.restitution_date,
...
def fsec_mapper_bean_to_entity(bean: FsecBean) -> FsecEntity:
    ...
    entity.version_number = bean.version_number
    entity.is_current_version = bean.is_current_version
    ...
    entity.current_step = bean.current_step
    entity.created_by = bean.created_by
    entity.updated_by = bean.updated_by
    ...
    entity.embase = bean.embase
    entity.restitution_date = bean.restitution_date
    return entity
...
def fsec_mapper_api_to_bean(data: Dict[str, Any]) -> FsecBean:
    ...
    return FsecBean(
        ...
        is_current_version=data.get("is_current_version", True),
        ...
        embase=data.get("embase"),
        restitution_date=parse_date_string(data.get("restitution_date")),
...
def fsec_mapper_bean_to_api(bean: FsecBean) -> Dict[str, Any]:
    ...
    return {
        ...
        "version_number": bean.version_number,
        "is_current_version": bean.is_current_version,
        ...
        "embase": bean.embase,
        "restitution_date": bean.restitution_date.isoformat() if bean.restitution_date else None,
