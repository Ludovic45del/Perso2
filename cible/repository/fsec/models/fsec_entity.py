...
class FsecEntity(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(
                fields=["fsec_uuid", "is_current_version"], name="idx_fsec_current"
            ),
            models.Index(fields=["current_step"], name="idx_fsec_step"),
        ]
    ...
    # TODO: Décommenter quand InstallationEntity sera créée
    ...
    current_step = models.CharField(
        ...
        null=True,
        blank=True,
        help_text="Étape actuelle du workflow (design, assembly, metrology, etc.)",
    )
    ...
    # Champs supplémentaires pour correspondance avec ancien front
    embase = models.CharField(
        max_length=100, null=True, blank=True, help_text="Embase/Interface (Sealing Step)"
    )
    restitution_date = models.DateField(
        null=True, blank=True, help_text="Date de restitution du FSEC"
    )
